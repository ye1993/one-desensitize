package cn.madcoder.one.framework.desensitize.core.base.serializer;
...
import cn.madcoder.one.framework.desensitize.core.base.annotation.DesensitizeBy;
import cn.madcoder.one.framework.desensitize.core.base.handler.DesensitizationHandler;
 ...
 * 该StdSerializer类是Jackson的类库，如果需要别的json类库需要修改别的方法
 *
 * @author madcoder
 */
